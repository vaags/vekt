...
juce::AudioProcessorValueTreeState::ParameterLayout createLayout()
{
	...
	layout.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID { filterEnvelopeAmount, version }, "Filter Envelope", juce::NormalisableRange<float> { -100.0f, 100.0f, 0.01f }, 50.0f, juce::AudioParameterFloatAttributes {}.withLabel("%")));
